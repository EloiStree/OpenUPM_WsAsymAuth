...
public class ConnectArrayToServerTunnelingEthMaskMono : MonoBehaviour
{
    public string m_serverUri = "ws://81.240.94.97:4501";
    public string[] m_privateKeys= new string[12];
    public List<WebsocketConnectionEthMaskTunneling> m_tunnels;
    ...
    public void ForceToReconnectAll() {
        ...
        if(m_tunnels == null)
            m_tunnels = new List<WebsocketConnectionEthMaskTunneling>();
